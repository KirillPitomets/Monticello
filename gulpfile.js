let projectFodler = require('path').basename(__dirname); // для изменения имени папки место "dist"
let sourceFolder = 'app'; // юзаю в path
...
=================================
=================================
Если обновить imagemin и появиться ошибка с reqire то вернут на версию 7.1.0
*/ 
